...
- приметы машинного текста: «не просто X, а Y» и «это не X — это Y» чаще одного раза, перечисления ровно по три ради ритма, цепочки риторических вопросов, одинаковые начала соседних предложений, пустые усилители («невероятный», «уникальный», «ключевой»), дежурные итоги («В итоге», «Таким образом»);
